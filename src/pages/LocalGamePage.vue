...
function restart(): void { gameVersion.value++; animating.value = false; aiThinking.value = false; state.value = createState(mode, 1, difficulty, catOnly); }
